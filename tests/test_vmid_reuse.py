...
# ---------------------------------------------------------------------------
# Guest type override via edit
# ---------------------------------------------------------------------------


class TestEditGuestType:
    """Test changing guest_type via the edit form."""

    def test_edit_type_change_clears_data(self, auth_client, app, vm_guest):
        """Changing guest type via edit should clear stale data."""
        resp = auth_client.post(f"/guests/{vm_guest}/edit", data={
            "guest_type": "ct",
            "connection_method": "ssh",
            "require_snapshot": "inherit",
    ...
    def test_edit_same_type_preserves_data(self, auth_client, app, vm_guest):
        """Submitting same type should NOT clear child data."""
        resp = auth_client.post(f"/guests/{vm_guest}/edit", data={
            "guest_type": "vm",
            "connection_method": "ssh",
            "require_snapshot": "inherit",
